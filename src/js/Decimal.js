  ...
  if (assertBool($eq(e, undefined))) {
    matcher([
      ...
      [matcher.wildcard("_"), function (_) {
        const toThrow = $plus$plus($plus$plus("", _), " cannot be coerced into a Decimal.");
  ...
  return stone({
      ...
      if (assertBool(not($eq(other["e"], e)))) {
        if (assertBool($lt(other["e"], e))) {
          ...
          while (true) {
            ...
            other = Decimal(JS["*"](other["c"], BigInt(10)), $minus(other["e"], 1), true);
          }
        }
      }
    ...
    ["/"]: function (other, precision = -20) {
      ...
      if (assertBool($gt(newE, precision))) {
        newC = JS["*"](c, JS["**"](BigInt(10), BigInt($minus(newE, precision))));
        newE = precision;
      }
    ...
    ["toString"]: function () {
      ...
      if (assertBool($gt(e, 0))) {
        ...
        if (assertBool($eq(e, 0))) {
          ...
          const zeros = ($gt(Math["abs"](e), str["length"])) ? "0"["repeat"](Math["abs"]($plus(str["length"], e))) : "";
...
var normalize = function (c, e) {
  if (!($eq(typeOf(c), "bigint"))) { throw new Error("Enter failed") }
  if (!($eq(typeOf(e), "number"))) { throw new Error("Enter failed") }
  if (assertBool($gt(e, 0))) {
    ...
    if (assertBool($lt(e, 0))) {
      while (true) {
        if (assertBool(or($gt(e, 0), not(JS["=="](JS["%"](c, BigInt(10)), 0))))) {
          break;
        }
        c = JS["/"](c, BigInt(10));
        e = $plus(e, 1);
...
Decimal["random"] = function () {
  ...
  const res = [];
    for (const _ of to(1, 20)) {
        if (true) res.push(str = $plus$plus(str, Math["random"]()["toString"]()[2]))
