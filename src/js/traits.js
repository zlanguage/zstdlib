...
const Show = function (obj) {
  obj["toString"] = function () {
    ...
    r = $plus$plus(r, obj["fields"]["map"](function (field$exclam) {
...
const Read = function (obj) {
  ...
  obj["read"] = function (str) {
    ...
    let args = undefined;
    try {
      args = str["split"]("(")[1]["slice"](0, -1)["split"](",")["map"](function (str$exclam) {
    ...
    if (assertBool(not(args["some"](function (arg$exclam) {
