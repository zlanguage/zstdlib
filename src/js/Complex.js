...
const Complex = function (real, imag) {
  ...
  if (assertBool(and($eq(typeOf(imag), "undefined"), $eq(typeOf(real), "string")))) {
  ...
  return stone({
    ...
    ["toString"]: function () {
      return $plus$plus($plus$plus($plus$plus($plus$plus("", real), " + "), imag), "i");
    },
    ["+"]: function (other) {
      other = Complex(other);
    ...
    ["*"]: function (other) {
      other = Complex(other);
      return Complex($minus($star(real, other["real"]), $star(imag, other["imag"])), $plus($star(real, other["imag"]), $star(imag, other["real"])));
    },
    ["r*"]: function (other) {
      other = Complex(other);
      return other["*"](this);
    ...
    ["/"]: function (other) {
      other = Complex(other);
      const denom = $plus($star(other["real"], other["real"]), $star(other["imag"], other["imag"]));
      return Complex($slash($plus($star(real, other["real"]), $star(imag, other["imag"])), denom), $slash($plus($star($star(real, other["imag"]), -1), $star(imag, other["real"])), denom));
    },
    ["r/"]: function (other) {
      other = Complex(other);
      return other["/"](this);
